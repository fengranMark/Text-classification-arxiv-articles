...
To run this code, you need to get enough corpus files which includes a "train.csv", a "test.csv". All files are provided in this depository and for the last file you can also change it into yours. The depository also provide an example for submission file and we will get one after we run this code.
...
Bagging.py is implemented by scikit-learn with bagging method. You can change basic model as you like at classifiers dictionary. Detailed analysis will post soon.

fasttext_demo.py is implemented by fasttext model.
